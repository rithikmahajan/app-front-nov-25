...
const CreateAccountMobileNumber = ({ navigation, route }) => {
...
const styles = StyleSheet.create({
  ...
  titleContainer: {
    paddingHorizontal: getResponsiveSpacing(34),
  ...
  inputContainer: {
    paddingHorizontal: getResponsiveSpacing(39),
  ...
  countrySection: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingLeft: getResponsiveSpacing(11),
  },
  flagContainer: {
    width: getResponsiveValue(25, 28, 32),
    height: getResponsiveValue(25, 28, 32),
    borderRadius: 50,
    backgroundColor: '#ffffff',
    justifyContent: 'center',
    alignItems: 'center',
  ...
  divider: {
    width: 1,
    height: getResponsiveValue(34, 40, 46),
  ...
  signUpButton: {
    marginHorizontal: getResponsiveSpacing(39),
    marginTop: getResponsiveSpacing(25),
    backgroundColor: '#000000',
    borderRadius: 26.5,
  ...
  socialButtonsContainer: {
    flexDirection: 'row',
    justifyContent: 'center',
    marginTop: getResponsiveSpacing(26),
  ...
  footer: {
    ...
    paddingHorizontal: getResponsiveSpacing(64),
  },
  footerText: {
    fontSize: getResponsiveFontSize(14),
    fontFamily: 'Montserrat-Regular',
