...
const styles = StyleSheet.create({
  ...
  loadingContainer: {
    ...
    alignItems: 'center',
    paddingHorizontal: wp(isTablet ? 6.7 : 5.3),
  },
  loadingText: {
  ...
  errorTitle: {
    ...
    fontWeight: '600',
    color: '#000000',
    marginBottom: hp(isTablet ? 1.9 : 1.5),
    textAlign: 'center',
  ...
  retryButton: {
    ...
    paddingHorizontal: wp(isTablet ? 10.7 : 8.5),
    marginBottom: hp(isTablet ? 2.5 : 2),
    minWidth: wp(isTablet ? 40 : 32),
  },
  retryButtonText: {
    fontSize: fs(isTablet ? 18 : isSmallDevice ? 14 : 16),
    fontWeight: '500',
  ...
  refreshingIndicator: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    paddingVertical: hp(isTablet ? 1.9 : 1.5),
    backgroundColor: '#F2F2F7',
    marginHorizontal: wp(isTablet ? 6.7 : 5.3),
    marginTop: hp(isTablet ? 2.5 : 2),
    borderRadius: 8,
  },
  refreshingText: {
    ...
    color: '#8E8E93',
    marginLeft: wp(isTablet ? 2.7 : 2.1),
    fontFamily: 'Montserrat-Regular',
  },
  statusText: {
    color: '#4CAF50',
  ...
  noItemsContainer: {
    paddingVertical: hp(isTablet ? 5 : 4),
    alignItems: 'center',
  },
  noItemsText: {
    fontSize: fs(isTablet ? 18 : isSmallDevice ? 14 : 16),
  ...
  backButton: {
    width: wp(isTablet ? 13.3 : 10.7),
    height: hp(isTablet ? 6.2 : 5),
    justifyContent: 'center',
  ...
  thankYouSection: {
    alignItems: 'center',
    paddingVertical: hp(isTablet ? 7.5 : 6),
    paddingHorizontal: wp(isTablet ? 6.7 : 5.3),
    backgroundColor: '#FFFFFF',
  },
  checkmarkContainer: {
    width: wp(isTablet ? 24 : 19.2),
    height: wp(isTablet ? 24 : 19.2),
    borderRadius: wp(isTablet ? 12 : 9.6),
  ...
  checkmark: {
    fontSize: fs(isTablet ? 42 : isSmallDevice ? 32 : 36),
    color: '#FFFFFF',
    fontWeight: 'bold',
  },
  thankYouTitle: {
  ...
  thankYouSubtitle: {
    ...
    lineHeight: fs(isTablet ? 28 : isSmallDevice ? 20 : 24),
    fontFamily: 'Montserrat-Regular',
    maxWidth: wp(isTablet ? 66.7 : 80),
  },
  section: {
    paddingHorizontal: wp(isTablet ? 6.7 : 5.3),
    paddingTop: hp(isTablet ? 2.5 : 2),
    paddingBottom: hp(isTablet ? 3.7 : 3),
    backgroundColor: '#FFFFFF',
  },
  sectionTitle: {
    fontSize: fs(isTablet ? 24 : isSmallDevice ? 18 : 20),
  ...
  itemSpecs: {
    fontSize: fs(isTablet ? 16 : isSmallDevice ? 13 : 14),
    color: '#8E8E93',
    marginBottom: hp(isTablet ? 0.9 : 0.7),
    fontFamily: 'Montserrat-Regular',
  },
  itemPrice: {
    fontSize: fs(isTablet ? 18 : isSmallDevice ? 14 : 16),
  ...
  infoSection: {
    paddingHorizontal: wp(isTablet ? 6.7 : 5.3),
    paddingVertical: hp(isTablet ? 3.7 : 3),
    backgroundColor: '#FFFFFF',
  },
  infoText: {
    fontSize: fs(isTablet ? 16 : isSmallDevice ? 13 : 14),
    color: '#8E8E93',
    textAlign: 'center',
    lineHeight: fs(isTablet ? 26 : isSmallDevice ? 19 : 22),
    fontFamily: 'Montserrat-Regular',
  },
  discountText: {
    fontSize: fs(isTablet ? 18 : isSmallDevice ? 14 : 16),
