...
const styles = StyleSheet.create({
  ...
  productImage: {
    width: wp(isTablet ? 46.6 : 37.3),
    height: wp(isTablet ? 46.6 : 37.3),
    backgroundColor: '#EEEEEE',
    borderRadius: 8,
  },
  productDetails: {
    flex: 1,
    marginLeft: wp(isTablet ? 4.7 : 3.7),
    justifyContent: 'flex-start',
    paddingTop: hp(isTablet ? 1.2 : 1),
  },
  statusContainer: {
  ...
  statusText: {
    ...
    fontWeight: '500',
    marginBottom: hp(isTablet ? 0.5 : 0.4),
    letterSpacing: -0.14,
    fontFamily: 'Montserrat-Medium',
  },
  productName: {
  ...
  productDescription: {
    ...
    fontWeight: '400',
    color: '#767676',
    lineHeight: fs(isTablet ? 20 : isSmallDevice ? 15 : 16.8),
  ...
  signInButton: {
    ...
    paddingVertical: hp(isTablet ? 2.2 : 1.7),
    borderRadius: 8,
