...
import { wp, hp, fs, device, isTablet, isSmallDevice } from '../utils/responsive';
...
const styles = StyleSheet.create({
  ...
  modalFormContainer: {
    ...
    paddingTop: hp(4),
    backgroundColor: '#FFFFFF',
    borderTopLeftRadius: wp(5.9),
    borderTopRightRadius: wp(5.9),
  },
  phoneContainer: {
    flexDirection: 'row',
    alignItems: 'center',
